...
onready var Config = $"/root/ConfigHandler"
onready var SaveData = Config.load_settings()
onready var MainMenu = $MainMenu
onready var OptionsMenu = $OptionsMenu
onready var VolumeSlider = $OptionsMenu/HBoxContainer/VBox1/HBoxMasterVolume/HSlider
onready var MusicVolumeSlider = $OptionsMenu/HBoxContainer/VBox1/HBoxMusicVolume/HSliderMusic
onready var mainInnerContainer = $MainMenu/Container/InnerContainer
...
func _on_NewGame_pressed():
	...
	$"/root/SceneHandler".goto_scene("res://Scenes/CharacterCreation.tscn")
